...
$data = [
  "Kevin" => [
    "general" => [
      ...
      "phone" => "+18595518787",
      "summary" => "software engineer seeking a management position.",
    ...
    "education" => [
      [
        ...
        "degree" => "Bachelor of Science - BS, Applied Software Engineering"
      ]
    ],
    "skills" => [
      "main" => [
    ...
    "languages" => ["English"],
    "interests" => ["hiking", "programming", "distributed systems"],
    "projects" => [
      [
        "title" => "Hallpass",
